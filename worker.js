...
// ============ ⚙ CONFIGURATION ============
const config = {
    host: 'http://geoiptv.one:8880/portal.php?type=stb', // Replace with your Stalker-Portal host (e.g., 'example.com')
    ...
    stb_type: 'MAG200', // Replace with Stalker-Portal Stb_type
